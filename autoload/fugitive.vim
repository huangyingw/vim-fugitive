...
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete G :execute s:G(<q-args>)")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Ga :execute s:Ga(<q-args>)")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gbib :execute s:Gbib()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gbidebug :execute s:Gbidebug()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gbig :execute s:Gbig()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gbil :execute s:Gbil()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gbis :execute s:Gbis()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gbr :execute s:Gbr()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gbra :execute s:Gbra()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gbrd :execute s:Gbrd(<f-args>)")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gbrm :execute s:Gbrm(<f-args>)")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gclean :execute s:Gclean()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gco :execute s:Gco(<f-args>)")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gcob :execute s:Gcob(<f-args>)")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gcof :execute s:Gcof(<f-args>)")
...
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Grtu :execute s:Grtu()")
...
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gstlv :execute s:Gstlv()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gstp :execute s:Gstp(<q-args>)")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Gstv :execute s:Gstv(<q-args>)")
...
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete Prune :execute s:Prune()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete SvnApply :execute s:SvnApply()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete SvnDiff :execute s:SvnDiff()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete SvnReset :execute s:SvnReset()")
call s:command("-bang -bar -nargs=* -complete=customlist,s:EditRunComplete SvnRevert :execute s:SvnRevert()")
...
function! s:BinaryGrep(...) abort
    ...
    let b:keyword = substitute(b:keyword, "/", "_", "g")
    OpenOrSwitch(b:keyword . '.binaryGrep.findresult', 'vs')
endfunction

function! s:Fnotinuse() abort
    Cd2ParentFolder("files.proj")
    call asyncrun#run('<bang>', '', 'bash ~/loadrc/bashrc/fnotinuse.sh')
    OpenOrSwitch('fnotinuse.findresult', 'vs')
endfunction
...
function! s:Glf() abort
    ...
    OpenOrSwitch('glf.findresult', 'vs')
endfunction
...
function! s:Glg() abort
    ...
    OpenOrSwitch('glg.findresult', 'vs')
endfunction
...
function! s:Fsync() abort
    ...
    OpenOrSwitch('fsync.findresult', 'vs')
endfunction
...
function! s:Gbil() abort
    ...
    OpenOrSwitch('gbil.findresult', 'vs')
endfunction
...
function! s:Gbr() abort
    ...
    OpenOrSwitch('gbr.findresult', 'vs')
endfunction
...
function! s:Gstl() abort
    ...
    OpenOrSwitch('gstl.findresult', 'vs')
endfunction
...
function! s:Gme2(args, ...) abort
    ...
    OpenOrSwitch(worktree . '/' . 'gme2.findresult', 'vs')
endfunction
...
function! s:VS(...) abort
    if a:0 >= 1
        ...
        OpenOrSwitch(expand("%:p") . '.findresult', 'vs')
    endif
endfunction
...
function! s:Gtg() abort
    ...
    OpenOrSwitch('gtg.findresult', 'vs')
endfunction
...
function! s:Gdifo(...) abort
    ...
    OpenOrSwitch('gdif.findresult', 'vs')
endfunction
...
function! s:Dodev() abort
    let worktree = GetWorktree()
    exec "cd " . worktree
    OpenOrSwitch('docker-compose.yml', 'vs')
endfunction
...
function! s:Dps() abort
    ...
    OpenOrSwitch('dps.findresult', 'vs')
endfunction
...
function! s:SvnReset() abort
    ...
    OpenOrSwitch('svnreset.findresult', 'vs')
endfunction
...
function! s:SvnSt() abort
    ...
    OpenOrSwitch('svnst.findresult', 'vs')
endfunction
...
function! s:FindDeleted() abort
    ...
    OpenOrSwitch('find_deleted.findresult', 'vs')
endfunction
